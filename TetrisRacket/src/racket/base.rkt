...
(struct tetris (campo largura altura tetra proximos timeout pontos nivel) #:transparent)
...
;; A cada nivel diminui 4.
(define (get-timeout niv)
  (- 20 (* (sub1 niv) 4)))
...
;; Define o expoente inicial para a pontuacao.
(define PONTUACAO-BASE 7)

;; Define o nivel inicial do jogo.
(define NIVEL-BASE 1)

;; Pontos por linha
;; A cada nivel, aumenta 5.
(define (get-points niv)
  (+ 25 (* (sub1 niv) 5)))
